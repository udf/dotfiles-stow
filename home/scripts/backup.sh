...
echo 'Syncing root...'
rsync -aAXHxx --delete --info=progress2 --exclude={/dev,/proc,/sys,/tmp,/run,/lost+found,/nix/store,/home/sam/Downloads,/home/sam/.cache,/home/sam/.local/share/nicotine,/var/lib/libvirt/images} / /backup/root/
echo 'Syncing boot...'
