...
alias ytpadl='youtube-dl -ciwx --no-post-overwrites -o "%(playlist)s/%(title)s-%(id)s.%(ext)s"'
alias ytpvdl='youtube-dl -f bestvideo+bestaudio -o "%(playlist)s/%(title)s-%(id)s.%(ext)s"'
