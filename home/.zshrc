...
# youtube-dl
alias ytadl='youtube-dl -f bestaudio --no-post-overwrites -ciwx'
alias ytvdl='youtube-dl -f bestvideo+bestaudio'
alias ytpadl='youtube-dl -ix -f bestaudio --no-post-overwrites -o "%(playlist)s/%(playlist_index)s. %(title)s-%(id)s.%(ext)s"'
